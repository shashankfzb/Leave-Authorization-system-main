       ...
       <div class="col s12 m12 l12">
           <div class="card">
               <div class="card-content">
                                <div class="page-title" style="color: green;">Leaves Granted</div>
                                ...
                                <table id="example" class="display responsive-table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="color: red;">Leaves_Alloted</th>
                                            <th style="color: red;">Remainingleaves</th>   
...
{               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->NumOfLeaves);?></td>
                                            <td><?php echo htmlentities($result->NumOfLeaves);?></td>
...
<div class="input-field col m6 s12">
<label for="todate">Branch</label>
<input placeholder="" id="mask1" name="todate" class="masked" type="text" required>
</div>
<div class="input-field col m6 s12">
<label for="todate">semester</label>
<input placeholder="" id="mask1" name="todate" class="masked" type="text" required>
</div>
<div class="input-field col m6 s12">
<label for="todate">Period no.</label>
<input placeholder="" id="mask1" name="todate" class="masked" type="text" required>
</div>
<div class="input-field col m6 s12">
<label for="todate">Teacher Name</label>
<input placeholder="" id="mask1" name="todate" class="masked" type="text" required>
</div>
