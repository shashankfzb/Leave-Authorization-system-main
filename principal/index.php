...
echo "<script type='text/javascript'> document.location = 'dashboard.php?a=all'; </script>";
} else{
...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>GYAN GANGA INSTITUTE OF TECHNOLOGY AND SCIENCES |  HOD</title>
...
<nav class="navbar navbar-expand-lg navbar-light py-3 bg-dark">
          ...
          <div class="navbar-nav d-flex justify-content-center align-items-center">
            ...
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="../admin/index.php">Registrar Login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="../index.php">Faculty Login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="#">HOD login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="#">Principal login</a>
        ...
        <h4 class="font-weight-bold text-center text-danger">Welcome to GGITS</h4>
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  <div class="card-content">
                                      <span class="card-title text-danger" style="font-size:20px;">Principal Login</span>
                                       <div class="row">
