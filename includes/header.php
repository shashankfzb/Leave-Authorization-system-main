        ...
        <div class="mn-content fixed-sidebar">
          ...
          <div class="collapse navbar-collapse d-flex justify-content-center align-items-center" id="navbarNavAltMarkup">
             <marquee width="100%" direction="left" behavior="alternate" ><span style="font-size:38px;font-weight:bold;color:white;font-family:'Californian FB', cursive;">GYAN GANGA INSTITUTE OF TECHNOLOGY AND SCIENCES</span>
        </marquee>
