...
<html lang="en">
    <head>
        ...
        <!-- Title -->
        <title>GYAN GANGA INSTITUTE OF TECHNOLOGY AND SCIENCES |  Admin</title>
...
<nav class="navbar navbar-expand-lg navbar-light py-3 bg-dark">
          ...
          <div class="navbar-nav d-flex justify-content-center align-items-center">
            ...
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="#">Registrar Login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="../index.php">Faculty Login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="../hod/index.php">HOD login</a>
            <a class="nav-item text-white font-weight-bold nav-link ml-3" href="../hod/index.php">Principal login</a>
                          ...
                          <div class="col-md-6 d-flex justify-content-center align-items-center">
                              <div class="card white darken-1">
                                  <div class="card-content">
                                      <span class="card-title text-danger" style="font-size:20px;">REGISTRAR Login</span>
                                       <div class="row">
