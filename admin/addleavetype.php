...
$numofleave=$_POST['numofleave'];
$sql="INSERT INTO tblleavetype(LeaveType,Description,NumOfLeaves) VALUES(:leavetype,:description,:numofleave)";
$query = $dbh->prepare($sql);
$query->bindParam(':leavetype',$leavetype,PDO::PARAM_STR);
$query->bindParam(':description',$description,PDO::PARAM_STR);
$query->bindParam(':numofleave',$numofleave,PDO::PARAM_STR);
$query->execute();
...
<div class="input-field col s12">
<input id="numofleave" type="number"  class="validate" autocomplete="off" name="numofleave"  required>
<label for="numofleave">No Of Leaves</label>
</div>
